...
import com.universal.framwork.http.AsyncHttpResponseHandler.ResponderHandler;
...
public class AsyncHttpClient {
    ...
    public RequestHandle download(String url,AsyncHttpResponseHandler responseHandler)
    {
      return download(null, url, null, responseHandler);
    }
    
    public RequestHandle download(String url,RequestParams params,AsyncHttpResponseHandler responseHandler)
    {
      return download(null, url, params, responseHandler);
    }
    
    public RequestHandle download(Context context,String url,AsyncHttpResponseHandler responseHandler)
    {
      return download(context, url, null,responseHandler);
    }
    public RequestHandle download(Context context,String url,RequestParams params,AsyncHttpResponseHandler responseHandler)
    {
      return sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(isUrlEncodingEnabled, url, params)), null, responseHandler, context);
    }
