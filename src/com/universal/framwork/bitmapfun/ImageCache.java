...
public class ImageCache {
    ...
    public static File getExternalCacheDir(Context context) {
        if (Utils.hasFroyo()) {
            LogUtil.d("yzy", "hasFroyo is true return path is -->"+context.getExternalCacheDir());
            return context.getExternalCacheDir();
        }
        LogUtil.d("yzy", "hasFroyo is false return path is -->"+"/Android/data/" + context.getPackageName() + "/cache/");
